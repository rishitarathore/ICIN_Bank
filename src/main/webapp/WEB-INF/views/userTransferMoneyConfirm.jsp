...
<html lang="en">
  ...
  <p id="custom-alert-success" class="alert alert-success my-5 py-4"
			...
			${transfer_session.transferId} <br> Rs.
			${transfer_session.amount} has been credited to account
			${transfer_session.recipientAccount}.Your Balance is Rs
			${account_session.balance} <br>
		</p>
